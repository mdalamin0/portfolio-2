...
const Nav = () => {
  return (
    <nav className="fixed bottom-2 lg:bottom-8 overflow-hidden w-full z-50">
      <div className="container mx-auto">
        <div className="w-full bg-black/20 h-[90px] backdrop-blur-2xl rounded-full 
        max-w-[460px] mx-auto px-5 flex justify-between items-center text-2xl text-white/50">
          ...
          <Link to="work" activeClass="active" smooth={true} spy={true} offset={100}className="cursor-pointer w-[60px] h-[60px] flex items-center justify-center">
